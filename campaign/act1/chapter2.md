...
- **The Drawn and Quartered**: A former pirate schooner recently repossesed by the Neverwinter Guard.(See *Appendix D*)
  - **Price:** This ship will be offered at auction, the highest opposing bid should be no more than 18,000 GP. More details are available in the section *Bustling Auction*
...
1. **Bustling Auction:** The auction for **The Drawn and Quartered** can be a dynamic and interactive event, giving players a chance to use skills and creativity to secure the ship.

    - **Setup:**
      - The auction is being held at the end of a pier in front of the ship drawing a crowd of merchants, sailors, and opportunistic bidders.
      - Bidding starts at **10,000 GP** and increases in increments of **500 GP**
      - There are three NPC bidders eyeing the ship
      1. **Marus Trade Guild:** A small group of focused and practical individuals, willing to bid up to **14,000 GP**.
      2. **Captain Evra Sennick:** A flamboyant privateer with deep pockets willing to bid up to **18,000 GP**.
      3. **Anonymous Figure:** A shady bidder who keeps his distance at the edge of the crowd, bids up to **15,000 GP** before dissappearing off of the pier
    - **Skill Challenges:** Players can use skill checks from the table below to influence the auction. Success provides advantages, while failure might raise suspicion or increase competition.

| Skill	| DC | Effect |
| ----- | -- | ------ |
| Charisma (Persuasion)	| 14 | Convince the crowd or auctioneer that the party deserves the ship, reducing the final bid by 10%. |
| Charisma (Deception) | 16 | Spread rumors about rival bidders, forcing one to drop out early. |
| Charisma (Intimidation) | 15 | Intimidate a rival into withdrawing, but risks backlash (disadvantage on later skill checks). |
| Wisdom (Perception) | 13 | Notice suspicious activity or detect a rival’s limits during the auction. |
| Dexterity (Sleight of Hand) | 17 | Secretly interfere with a rival bidder’s funds, disqualifying them from bidding. |
...
> **Read Aloud:**
> A town crier’s voice rings out over the docks: “The esteemed vessel The Drawn and Quartered is to be auctioned this very afternoon! A fine schooner, fully equipped for voyages far and wide! Secure your future on the seas!”

4. **Merchant Bargains:** The charming yet opportunistic Merchant Flaris Goldtounge has supplies as well as a few minor magical items, all being sold at an inflated price.
    - **Skill Challenge:** Charisma (Persuasion, DC 13) check will reduce prices by 25%.
> **Read Aloud:**
> A flamboyant merchant with an array of exotic wares gestures to passersby, shouting, “A sailor is only as good as his gear! Step right up! Finest rope, tools, and talismans this side of the Sword Coast!”
